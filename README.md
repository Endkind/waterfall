...
```bash
docker run -it -d -p 25565:25577 endkind/waterfall:1.11
```

By specifying a version like 1.11, you ensure that your server runs a known and tested version of Waterfall.
